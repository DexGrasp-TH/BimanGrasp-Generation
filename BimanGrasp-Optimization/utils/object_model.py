...
class ObjectModel:
    ...
    def initialize(self, object_code_list):
        ...
        for object_code in object_code_list:
            ...
            # Load object mesh
            if self.bodex_format:
                mesh_path = os.path.join(self.data_root_path, object_code, "mesh", "simplified.obj")
            else:
            ...
            if self.num_samples > 0:
                ...
                pytorch3d_mesh = pytorch3d.structures.Meshes(object_verts.unsqueeze(0), faces_float.unsqueeze(0))
